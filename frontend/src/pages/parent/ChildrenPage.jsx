...
export default function ChildrenPage() {
  ...
  const handleOpenSummary = (child) => {
    const studentId = child?._id || child?.id
    if (!studentId) return
    navigate(`/parent/child/${studentId}/summary`)
  }
        ...
        >
          {filtered.map((child, i) => (
            <div
              ...
              onClick={() => handleOpenSummary(child)}
          ...
          >
            ...
            <p style={{ fontSize: 13, color: '#7c3aed', fontWeight: 700, margin: 0 }}>
              Add a child
            </p>
      ...
      {addedChildInfo && (
        <div
          style={{
            ...
            boxShadow: '0 18px 45px rgba(12, 12, 71, 0.12)',
            width: 320,
            padding: '18px 20px',
            color: '#1f2937',
          }}
